<template>
  ...
  methods: {
    handleButtonClick() {
      // handle button click
      if (this.buttonDestination) {
        this.$router.push({ name: this.buttonDestination });
      }
    },
  },
};
  ...
  .navbar {
    ...
    border-bottom: 3px solid #2720FF;
  }
  ...
  .logo {
    width: 110px;
    height: auto;
    margin-right: 10px; /* Add margin between logo and brand */
  }
